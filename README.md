...
当前有效架构基线见 [当前开发路线与架构基线](./当前开发路线与架构基线.md)。

长期设计仍以 [长期架构与 Durable Objects 迁移设计 V3](./长期架构与DurableObjects迁移设计_V3.md) 为主。2026-08-17 后续产生的 V4 unified architecture 属于探索方案，不再作为实施基线；如与当前基线或 V3 冲突，以当前基线 + V3 为准。
