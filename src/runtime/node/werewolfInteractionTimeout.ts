...
import { activeInteraction, type RuntimeRoom } from "./roomBridge.js";
import { runPlayerCommand } from "./werewolfCommandFacade.js";
...
/**
 * C4.4 timeout recovery completes only the current secret interaction. It never
 * exposes the actor or secret answer to the host and never performs a generic
 * phase skip.
 */
